...
@else
    <div {{ $attributes->class('@container pt-3 border-t border-zinc-100 dark:border-zinc-700 flex justify-between items-center gap-3 relative z-15') }} data-flux-pagination>
        ...
        @if ($paginator->hasPages())
            ...
            {{-- Desktop pagination --}}
            <div class="hidden @[40rem]:flex items-center bg-white border border-zinc-200 rounded-[8px] p-[1px] dark:bg-white/10 dark:border-white/10 relative z-15">
                @if ($paginator->onFirstPage())
